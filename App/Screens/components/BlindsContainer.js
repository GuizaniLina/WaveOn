...
const BlindsContainer = ({ sliderValues, onPress3,onSliderChange ,name}) => {
  ...
  return (
    <TouchableOpacity onPress={onPress3} style={[styles.deviceContainer, { backgroundColor: theme.$standard, borderColor: theme.$standard }]}>
