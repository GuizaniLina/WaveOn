...
const SetUserAsGatewayRequestService = async (idclient, iduser, token) => {
    try {
        ...
        const response = await axios.post(`${BASE_URL}/SetUserAsGatewayRequestService/`,requestData);
        ...
        throw new Error('Échec d"envoyer la demande pour etre un Gatway' + error.message);
    }
};

export default SetUserAsGatewayRequestService;